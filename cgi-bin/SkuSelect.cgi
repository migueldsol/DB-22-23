...
print('    <link')
print('      href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css"')
print('      rel="stylesheet"')
print('      integrity="sha384-9ndCyUaIbzAi2FUVXJi0CjmCapSmO7SnpJef0486qhLnuZ2cdeRhO02iuK6FUUVM"')
...
print('        </a>')
print('      </div>')
print('      <form action="RemoveProduct.cgi">')
...
print("    <script src='https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js'></script>")
print("    <script>")
print("      $(document).ready(function () {")
print("        $('#product_sku').select2();")
print("      });")
print("    </script>")
print("  </body>")
print("</html>")