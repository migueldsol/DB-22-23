...
try:
    ...
    cursor.execute("SELECT price FROM product WHERE product.sku = {};").format(product_sku)
...
print('          <img src="icons/back.png" alt="Back" style="width: 50px; height: 50px" />')
print('        </a>')
print('      </div>')
print('      <div class="mb-3">')
print('        <label for="product_sku" class="form-label">New Price</label>')
print('        <input readonly type="number" class="form-control" id="product_sku" value = {} />'.format(product_sku))
print('      </div>')
print('      <form action="AlterPriceCheck.cgi" method="post">')
print('        <div class="mb-3">')
print('          <label for="new_price" class="form-label">New Price</label>')
print('          <input required type="number" class="form-control" id="new_price" name="new_price" placeholder="Enter product\'s new price" />')
print('        </div>')
