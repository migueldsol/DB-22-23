...
print('        <a href="ManageSuppliers.html" class="mb-5" style="margin-right: 25px">')
print("          <img")
...
print("          <thead>")
print("            <tr>")
print("              <th class='text-center'>tin</th>")
...
try:
    ...
    for row in result:
        ...
        print("                <form action='RemoveSupplier.cgi' method='POST'>")
        print(
            "                  <input type='hidden' name='tin' value='{}' />".format(
                row[0]
            )
        )
        print("                  <button")
